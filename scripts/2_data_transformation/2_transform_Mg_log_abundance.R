# Script Title: Transform Miscanthus Abundance Data to Long Format
# 
# Description: Transforms Miscanthus normalized abundance data from wide to long
...
#
# Input: 
#   - 0_Mg_clean-data_removed-NA.csv - Filtered Miscanthus dataset
#
# Output:
#   - 0_Mg_log-normalized-abundances_long-format.csv - Long-format data
...
df <- read_csv("0_Mg_2_clean-data_removed-NA.csv")
...
write_csv(df_norm_long, "0_Mg_3_log-normalized-abundances_long-format.csv")
