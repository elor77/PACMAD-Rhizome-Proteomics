# Script Title: Visualize LEA Phylogenetic Tree with Expression Data and Clade Labels
# 
# Description: Constructs and visualizes a phylogenetic tree of late embryogenesis abundant (LEA) proteins 
#              across multiple grass species. Overlays differential protein abundance (log2 fold change) 
#              as a heatmap, colors tips by orthogroup, labels specific clades, and highlights significant 
#              proteins based on adjusted p-values.
#
...
#   - 5b_LEA_tree_basic.pdf - Basic tree with expression heatmap
#   - 5b_LEA_tree_basic_tips_colored.pdf - Tree with colored tips by orthogroup
#   - 5b_LEA_tree_p_nodes.pdf - Tree with node IDs labeled for bracket reference
#   - 5b_LEA_tree_bracketed.pdf - Final bracketed tree with clade labels and significance asterisks
#
...
#   - Clades are manually labeled based on specified node IDs.
#   - Rooting and tip labels are adjusted for clarity in visualization.
...
print(plot_1)
ggsave("5b_LEA_tree_basic.pdf", plot_1, width = 10, height = 12)

# Create and save heatmap with colored tips
plot_2 <- create_tree_heatmap(subTre, log2fc, color_tips = TRUE)
print(plot_2)
ggsave("5b_LEA_tree_basic_tips_colored.pdf", plot_2, width = 10, height = 12)
...
# Save final plot
ggsave("5b_LEA_tree_bracketed.pdf", plot_bracketed, width = 12, height = 8)
