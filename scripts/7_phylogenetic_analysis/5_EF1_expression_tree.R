...
#              Differential protein abundance (log2 fold change) is visualized as a heatmap overlay.
#              Tips are optionally colored by orthogroup. Significant proteins are marked with asterisks.
#              Clades corresponding to orthogroups are labeled based on predefined node positions.
#
...
#
# Input: 
#   - ../1_tables/6a_EF1_protein_og_id_desc.txt - EF1 protein-to-orthogroup and description mapping
...
#   - ../RAxML/RAxML_bestTree.33_EF1_proteins.tree - Phylogenetic tree from RAxML
#
# Output:
#   - EF1_proteins_for_extraction.txt - Protein IDs and corresponding proteomes for sequence retrieval
#   - EF1_protein_name_mapping.txt - Mapping of full protein IDs to short names
#   - EF1_expression_with_descriptions.txt - Final expression dataset with descriptions
#   - EF1_tree_basic.pdf - Basic phylogenetic tree with heatmap
#   - EF1_tree_basic_tips_colored.pdf - Tree with tips colored by orthogroup
#   - EF1_tree_bracketed.pdf - Final tree with clade labels and significance markers
#
...
#   - Rooting and tip layouts are optimized for visual clarity.
...
print(plot_1)
ggsave("EF1_tree_basic.pdf", plot_1, width = 10, height = 12)

# Create and save heatmap with colored tips
plot_2 <- create_tree_heatmap(subTre, log2fc, color_tips = TRUE)
print(plot_2)
ggsave("EF1_tree_basic_tips_colored.pdf", plot_2, width = 10, height = 12)
...
# Save final plot
ggsave("EF1_tree_bracketed.pdf", plot_bracketed, width = 12, height = 8)
