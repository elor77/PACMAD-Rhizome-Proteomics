# =============================================================================
# Script Title: Transform Ag Abundance Data to Long Format
# 
# Description: Transforms Ag normalized abundance data from wide to long
...
#
# Input: 
#   - 0_Ag_clean-data_removed-NA.csv - Filtered Ag dataset
#
# Output:
#   - 0_Ag_log-normalized-abundances_long-format.csv - Long-format data
...
df <- read_csv("0_Ag_clean-data_removed-NA.csv")
...
write_csv(df_norm_long, "0_Ag_log-normalized-abundances_long-format.csv")
